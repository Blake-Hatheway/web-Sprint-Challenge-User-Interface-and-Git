...
Semantic elements are elements wit meaning.They provide structure.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

Display block respects padding and margins inline does not.
...
It allows people to colaborate and store their project and makes it easy to work without trampling someone elses work.
