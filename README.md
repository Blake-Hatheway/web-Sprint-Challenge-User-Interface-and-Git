...
Semantic elements brings content to the page.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

block has its own line where as inline shares the line.
...
It allows multiple people to work on parts of the project and submit their work for review and integration without corrupting the initial file.
